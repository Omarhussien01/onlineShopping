      ...
      <div class="product-item bg-light mb-4">
        <div class="product-img position-relative overflow-hidden">
          ...
          <div class="product-action">
            <a class="btn btn-outline-dark btn-square" href="#" onclick=""><i class="fa fa-shopping-cart">e</i></a>
  ...
  products.forEach((element) => {
    ...
    <div class="product-item bg-light mb-4">
      <div class="product-img position-relative overflow-hidden">
        <img class="img-fluid w-100" src="${element.image}" alt="">
        <div class="product-action">
          <a class="btn btn-outline-dark btn-square" href="javascript:void(0)" onclick="">
          <i  data-id="${element.name}" class="fa fa-shopping-cart cart"></i></a>
